...
const Brokerage = () => {
    ...
    const isValue = parseFloat(value) || 0
    const brokerage = (isValue * 0.01).toFixed(2)
            ...
            <ul className="list-none text-center md:flex justify-between">
                <li>
                    <ul className="text-md-start brokerage-form list-none">
                        ...
                        <li>
                            ...
                            <p className="inline-block h5 text-green-600" id="amount-label">
                                {isValue}
                            </p>
                        </li>
                    </ul>
                ...
                <li className="mt-2 mt-sm-0">
                    <ul className="text-md-end brokerage-form list-none">
                        <li className="font-medium">
                            <label className="control-label">Brokerage Fee ($)</label>
                        </li>
                        <li>
                            <input type="hidden" id="saving" className="form-control" />
                            <span className="text-green-600">$</span>{' '}
                            <p className="inline-block h5 text-green-600" id="saving-label">
                                {brokerage}
                            </p>
                        </li>
                    </ul>
