                        ...
                        <div className="md:w-3/4">
                            <div className="p-6 bg-white dark:bg-slate-900 shadow dark:shadow-gray-700 rounded-md">
                                ...
                                <p className="text-slate-400">
                                    ...
                                    <b className="text-danger-600">incomprehensible</b>, but it imitates the rhythm of
                                    most European languages in Latin script. The{' '}
                                    <b className="text-danger-600">advantage</b> of its Latin origin and the relative{' '}
                                    <b className="text-danger-600">meaninglessness</b> of Lorum Ipsum is that the text
                                ...
                                <p className="text-slate-400 mt-3">
                                    There is now an <b className="text-danger-600">abundance</b> of readable dummy
                                    texts. These are usually used when a text is{' '}
                                    <b className="text-danger-600">required purely</b> to fill a space. These
                                    alternatives to the classic Lorem Ipsum texts are often amusing and tell short,
                                    funny or <b className="text-danger-600">nonsensical</b> stories.
                                </p>
                                <p className="text-slate-400 mt-3">
