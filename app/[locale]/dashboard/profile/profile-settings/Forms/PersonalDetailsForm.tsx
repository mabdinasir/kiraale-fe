                ...
                <div className="grid lg:grid-cols-2 grid-cols-1 gap-5">
                    <div>
                        ...
                        <div className="form-icon relative mt-2">
                            ...
                            <input
                                type="text"
                                className="form-input ps-12 w-full py-2 px-3 h-10 dark:text-slate-200 rounded outline-none border border-gray-200 focus:border-green-600 dark:border-gray-700 dark:focus:border-green-600 focus:ring-0"
                    ...
                    <div className="mt-5">
                        ...
                        <div className="form-icon relative mt-2">
                            ...
                            <textarea
                                name="bio"
                                id="bio"
                                className="form-input ps-11 w-full py-2 px-3 h-28"
